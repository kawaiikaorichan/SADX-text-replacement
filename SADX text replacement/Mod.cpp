...
extern "C" __declspec(dllexport) void __cdecl Init(const char* path, const HelperFunctions & helperFunctions)
{
	...
	//Bosses
	WriteData((const char**)0x4E6C81, "E103Q"); //Delta
	...
	WriteData((const char**)0x566F64, "E101|"); //Beta, first version
	WriteData((const char**)0x56C2B1, "E101{"); //Beta Mark 2, Japanese
	WriteData((const char**)0x56C2B8, "E101mk{"); //Beta Mark 2, English
	WriteData((const char**)0x571813, "EGG HORNET");
	WriteData((const char**)0x5757B3, "EGG WALKER");
	WriteData((const char**)0x57F2A1, "EGG VIPER");
	WriteData((const char**)0x587DA4, "ZERO");
	WriteData((const char**)0x5A39F8, "E105q"); //Zeta
	WriteData((const char**)0x604791, "E104X"); //Epsilon
